  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Create Images through DALL-E AI</p>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          <FormField 
            ...
            type='text'
            name='prompt'
            placeholder='A yellow dog jumping over a fence'
            value={form.prompt}
            handleChange={handleChange}
            isSurpriseMe
        ...
        <div className='mt-5 flex gap-5'>
          <button
            ...
            text-sm w-full sm:w-full sm:w-auto px-5 py-2.5 text-center'
          >
            {generatingImg ? 'Generating...' : 'Generate'}
          </button>
        </div>
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>You can share your image with the community</p>
          <button
            type='submit'
